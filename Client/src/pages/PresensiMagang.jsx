...
export const PresensiMagang = () => {
  ...
  const exportPresensi = async () => {
    const requestUrl = searchDate
      ? `https://silly-elk-cummerbund.cyclic.app/admin/export-presensi?tanggal=${searchDate}`
      : 'https://silly-elk-cummerbund.cyclic.app/admin/export-presensi';
  ...
  const getUsers = async () => {
    ...
    const url = searchDate
      ? `https://silly-elk-cummerbund.cyclic.app/admin/presensi?tanggal=${searchDate}`
      : 'https://silly-elk-cummerbund.cyclic.app/admin/presensi';
  ...
  const getPresensiBelum = async () => {
    try {
      const response = await axiosJWTadmin.get('https://silly-elk-cummerbund.cyclic.app/admin/presensi/negatif');
      setUsers(response.data.presensi);
    } catch (error) {
      console.error('Error fetching data:', error);
    }
