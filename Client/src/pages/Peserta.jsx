...
export const Peserta = () => {
  ...
  const getPresensiPeserta = async (id) => {
    try {
      const pesertaResponse = await axiosJWTadmin.get(
        `https://silly-elk-cummerbund.cyclic.app/admin/peserta/${id}`
      );
      ...
      const presensiResponse = await axiosJWTadmin.get(
        `https://silly-elk-cummerbund.cyclic.app/admin/peserta/${id}/presensi`
      );
  ...
  const getUsers = async (category) => {
    try {
      ...
      const response = await axiosJWTadmin.get(
        `https://silly-elk-cummerbund.cyclic.app/admin/${endpoint}`
      );
  ...
  const exportPeserta = async () => {
    try {
      const response = await axiosJWTadmin.get(
        "https://silly-elk-cummerbund.cyclic.app/admin/export-peserta",
        {
  ...
  const exportPesertaAktif = async () => {
    try {
      const response = await axiosJWTadmin.get(
        "https://silly-elk-cummerbund.cyclic.app/admin/export-peserta-aktif",
        {
          responseType: "arraybuffer",
        }
      );
  ...
  const exportPesertaAlumni = async () => {
    try {
      const response = await axiosJWTadmin.get(
        "https://silly-elk-cummerbund.cyclic.app/admin/export-peserta-alumni",
        {
          responseType: "arraybuffer",
        }
      );
  ...
  const exportPesertaCalon = async () => {
    try {
      const response = await axiosJWTadmin.get(
        "https://silly-elk-cummerbund.cyclic.app/admin/export-peserta-calon",
        {
          responseType: "arraybuffer",
        }
      );
  ...
  const exportPresensiPerPeserta = async (id) => {
    try {
      const response = await axiosJWTadmin.get(
        `https://silly-elk-cummerbund.cyclic.app/admin/export-presensi-peserta/${id}`,
        {
          responseType: "arraybuffer",
        }
      );
    ...
    if (window.confirm("Apakah Anda yakin ingin menghapus pengguna ini?")) {
      try {
        await axiosJWTadmin.delete(
          `https://silly-elk-cummerbund.cyclic.app/admin/peserta/${id}/delete`
        );
        getUsers();
  ...
  const saveUser = async (e) => {
    e.preventDefault();
    try {
      await axiosJWTadmin.post("https://silly-elk-cummerbund.cyclic.app/admin/peserta/add", formData);
      getUsers();
