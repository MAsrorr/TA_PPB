...
const EditAdmin = ({ adminId, handleCloseModal, showEditAdminModal, updateAdminData }) => {
    ...
    const updateAdmin = async (e) => {
        e.preventDefault();
        try {
            await axiosJWTadmin.patch(`https://silly-elk-cummerbund.cyclic.app/admin/edit-admin/${adminId}`, {
                nama: adminData.nama,
    ...
    const getAdminById = async () => {
        try {
            const response = await axiosJWTadmin.get(`https://silly-elk-cummerbund.cyclic.app/admin/show-admin-id/${adminId}`);
            if (response.data) {
